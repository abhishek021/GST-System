...
class picture extends JWindow implements Runnable
{
	...
	public void run()
        {
		JLabel SplashLabel = new JLabel(new ImageIcon("gst.jpg"));
...
class start extends JFrame implements ActionListener 
{
	...
	Thread ThFormSplash = new Thread(pic);
		...
		setResizable(false);
		try{
        		setContentPane(new JLabel(new ImageIcon(ImageIO.read(new File("gst.jpg")))));
		}
		catch(Exception o)
		{
		}
		...
		administrator = new JButton("Government Body",cup);
		...
		operator = new javax.swing.JButton("Tax Payers",cup2);
